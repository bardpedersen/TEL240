"""
Name: Lavanyan Rathy        email: lavanyan.rathy@nmbu.no
Name: Peder Ørmen Bukaasen  email: peder.ormen.bukaasen@nmbu.no
Name: Bård Tollef Pedersen  email: bard.tollef.pedersen@nmbu.no
